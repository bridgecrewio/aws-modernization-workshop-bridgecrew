...
If you aren’t sure where to find the keys, go back to the Azure setup step or refer to [this guide](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/guides/service_principal_client_secret).
